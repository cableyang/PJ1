...
public class QRS
{
	  ...
	  public  QRS(double[] sample)
	{
		 sig0=new int[sample.length];
	...
	public double[] filter()
	{
		  ...
		  int[] QRS1 = QRS_algorithm(lowPass, nsamp); 
		  double[]ret=new double[QRS1.length];
	  ...
	  public static int[] QRS_algorithm(float[] lowPass, int nsamp) 
	  {         
