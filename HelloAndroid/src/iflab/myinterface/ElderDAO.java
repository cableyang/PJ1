...
public class ElderDAO 
{
	...
	public void creattable()
	{
		...
		try
		{
			db.execSQL("create table  if not exists "+tablename+"(id integer primary key,name varchar(20),age integer, address varchar(32), phone varchar(15), decription text, img blob)");
		} catch (Exception e)
		{
